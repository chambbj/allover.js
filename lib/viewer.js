...
(function() {
    ...
    this.init = function(options) {
        ...
        d3.select("#colorize-select").select("select").on("change", function() {
          that.colorizePointsBy( this.value );
        });

        d3.select("#colorbrewer-select").select("select").on("change", function() {
        ...
        this.container.on('keydown', function(event) { that.updatePointSizeWithKeys(event, that); });
    ...
    this.render = function() {
        ...
        this.stats.update();
        if (Allover.boundingbox.initialized) {
            Allover.boundingbox.render();
        }
    };
    ...
    this.pointloader = function(data, pointcounter, pointBucket) {
        ...
        this.controls.setInitialCenter(midx, midy, medianz);
        ...
        // Allover.boundingbox.init(this.container, this.scene, this.camera, pointBucket.geometry.boundingBox);
