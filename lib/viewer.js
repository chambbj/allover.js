    ...
    */
    ...
    if ( options.progressBar ) {
        ...
        scope.progressBar = {
          ...
          scope.progressBar.wrapper.insertAfter(scope.container);
          scope.progressBar.statusText.appendTo(scope.progressBar.wrapper);
          scope.progressBar.element.appendTo(scope.progressBar.wrapper);
          scope.progressBar.coloredBar.appendTo(scope.progressBar.element);
      ...
      scope.updatePointSize( DEFAULT_POINT_SIZE );
