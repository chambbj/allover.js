...
Allover.viewer = function( data, material, pbox, scene, controls, options ) {
    ...
    this.createSidebar = function( options ) {
        ...
        $( "#colorize-select" ).change( function() {
          ...
          if ( this.value === ( 'imagery' || 'intensity' || 'pcid' || 'classification' ) ) {
...
//        $( "#colorbrewer-select" ).attr( "disabled", "disabled" );
        ...
        $( "#pointSizeSlider" ).slider({
          ...
          slide: function( event, ui ) { scope.updatePointSize( ui.value ); }
    ...
    this.pushColorsIntoPointBucket = function( pointBucket, values ) {
        ...
        var elevationColor = new THREE.Color(),
            intensityColor = new THREE.Color(),
            pcidColor = new THREE.Color(),
            classificationColor = new THREE.Color(),
            elevationColorValue = this.scales.elevation(values.elevation),
            intensityColorValue = this.scales.intensity(values.intensity),
            pcidColorValue = this.scales.pcid(values.pcid),
            classificationColorValue = this.scales.classification(values.classification);
    ...
    this.createColorizeSelect = function() {

      $( '<optgroup label="Elevation" id="colorbrewer">' ).appendTo( '#colorize-select' );
      
      $( '<option selected value="imagery">Imagery</option>' ).appendTo( '#colorize-select' );
      $( '<option value="intensity">Intensity</option>' ).appendTo( '#colorize-select' );
      $( '<option value="pcid">Point Cloud ID</option>' ).appendTo( '#colorize-select' );
      $( '<option value="classification">Classification</option>' ).appendTo( '#colorize-select' );

      $( '<option value="Purples">Purples</option>' ).appendTo( '#colorbrewer' );
      $( '<option value="Blues">Blues</option>' ).appendTo( '#colorbrewer' );
      $( '<option value="Greens">Greens</option>' ).appendTo( '#colorbrewer' );
      $( '<option value="Oranges">Oranges</option>' ).appendTo( '#colorbrewer' );
      $( '<option value="Reds">Reds</option>' ).appendTo( '#colorbrewer' );
      $( '<option value="Greys">Greys</option>' ).appendTo( '#colorbrewer' );
      $( '<option value="Spectral">Spectral</option>' ).appendTo( '#colorbrewer' );
      $( '<option value="RdYlGn">RdYlGn</option>' ).appendTo( '#colorbrewer' );
      $( '<option value="RdYlBu">RdYlBu</option>' ).appendTo( '#colorbrewer' );

    };

    this.createKeyboardShortcuts = function() {
    ...
    scope.createSidebar( options );
    scope.loadPointsFromData();
    scope.createKeyboardShortcuts();
    scope.createColorizeSelect();
