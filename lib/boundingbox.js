...
(function() {
  ...
  var uniforms = {
      ...
      texture:   { type: "t", value: 0,
        texture: THREE.ImageUtils.loadTexture( "solid.png" )
      },
  ...
  this.render = function() {
    ...
    scaleBall(this.balls.rotate);
    scaleBall(this.balls.back);
    scaleBall(this.balls.front);
    scaleBall(this.balls.up);
    scaleBall(this.balls.down);
    scaleBall(this.balls.left);
    scaleBall(this.balls.right);
  ...
  function scaleBall(elem){
    elem.scale.z=elem.scale.y=elem.scale.x=distanceToCamera(elem)/500;
  }
  function distanceToCamera(elem){
