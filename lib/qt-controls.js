THREE.QTControls = function ( camera, domElement ) {
  ...
  this.mousemove = function( event ) {
    if ( this.mouseStatus === 1 ) {
      this.destinationRotation.xy = this.rotationOnMouseDown.xy + (event.pageX - this.mouseOnMouseDown.x) * -0.02;
      this.destinationRotation.z = this.rotationOnMouseDown.z + (event.pageY - this.mouseOnMouseDown.y) * 0.02;
  ...
  this.update = function( delta ) {
    ...
    // XXX scene flips when we go past the minz of the whole thing...why?
